...
public class AssemblyExpandableAdapter extends BaseExpandableListAdapter {
    ...
    private AssemblyLoadMoreGroupItemFactory.AssemblyLoadMoreGroupItem loadMoreItem;
    ...
    private AssemblyGroupItem createGroupItem(ViewGroup parent, int viewType) {
        ...
        if (item instanceof AssemblyGroupItemFactory) {
            ...
            if (assemblyItem instanceof AssemblyLoadMoreGroupItemFactory.AssemblyLoadMoreGroupItem) {
                this.loadMoreItem = (AssemblyLoadMoreGroupItemFactory.AssemblyLoadMoreGroupItem) assemblyItem;
            }
            return assemblyItem;
        }
